...
<br/> <br/>Galilée relate une expérience scientifique au bout de laquelle on aboutit tous à la conclusion que Io, Europe, Ganymède et Callisto sont en orbite autour de Jupiter.
<br/> <br/>
![](assets/Galilean_satellites.jpg)
...
[Il existe des outils pour ça (scripts numérotés, package `targets`)]{.small}
...
##  {data-background-image="assets/capture_positron-git.png"}
...
-   Conventions de code (encore)

-   Documentation de l'archive de recherche (README, DESCRIPTION, license, code de contribution)

-   Plateforme de collaboration en ligne (intègre `Git` !) : GitHub, GitLab, Codeberg, [forge.ird.fr](https://forge.ird.fr)
...
[[Donald Knuth, Literate Programming, 1984(http://www.literateprogramming.com/knuthweb.pdf)]]{.reference}
...
|               | - Compendium creation                           |
+---------------+-------------------------------------------------+
| **Tuesday**   | - Version control w/ Git (Part I, II, III)      |
