...
date: "Novembre 2021<br/><br/><br/><span class='caption'>francois.guilhaumon@ird.fr</span>"
output:
...
![](img/Galileo_Galilei_by_Peter_Paul_Rubens.jpg){width=40%}

Galileo Galilei, par Peter Paul Rubens (circa 1630)<br/>
<span class="small">Crédits : Wikimedia Commons</span>


## Un exemple 

![](img/Portrait_of_Jupiter_from_Cassini.jpg){width=40%}
...
![](img/Galilean_satellites.jpg){width=100%}
...
![](img/goodman_2014_fig1.png){width=70%}
...
<span class="small">Crédits : Goodman _et al._ (2014) PLoS Comput Biol 10(4): e1003542. doi:10.1371/journal.pcbi.1003542</span>

## Un exemple

<div class="container">
<div class="col" data-markdown>
![](img/Galileo_Galilei_by_Peter_Paul_Rubens.jpg){width=100%}
</div>
...
## {data-background-video="img/Bubbles_Animation.mp4" data-background-video-loop="true" data-background-size="cover"}

![](img/poker_face.png){width=60%}
...
![](img/goodman_2014_fig1.png){width=40%}
...
<span class="reference">Claerbout & Karrenbach 1992. http://sepwww.stanford.edu/doku.php?id=sep:research:reproducible:seg92</span>
...
<span class="reference">Wilson _et al._ 2016. Plos Comp Biol. https://arxiv.org/pdf/1609.00037.pdf</span>
...
> - <span class="green">Research compendium :</span> organisation du répertoire de travail

<br/>

> - <span class="green">Pipeline toolkit (`targets`) :</span> gère les dépendances entre données, scripts et résultats
...
![](img/rmarkdown_formats.png){width=50%}
